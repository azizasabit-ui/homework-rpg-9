...
public class Hero {
    ...
    public Hero(String name, int hp, int attackPower, int defense) {
        this(name, hp, 50, attackPower, defense, 100, new Inventory());
    }
